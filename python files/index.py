...
def OnSelected(event):
    ...
    Male = Radiobutton(RadioGroup, text="Male", variable=GENDER, value="Male",  font=('ms sans serif', 14)).pack(side=LEFT)
    Female = Radiobutton(RadioGroup, text="Female", variable=GENDER, value="Female",  font=('arial', 14)).pack(side=LEFT)
    
    #===================LABELS==============================
    lbl_title = Label(FormTitle, text="Updating Contacts", font=('comic ', 16), bg="orange",  width = 300)
    lbl_title.pack(fill=X)
    lbl_firstname = Label(ContactForm, text="Firstname", font=('comic', 14), bd=5)
    ...
    #===================ENTRY===============================
    firstname = Entry(ContactForm, textvariable=FINAME, font=('arial', 14))
...
def AddNewWindow():
    ...
    #===================LABELS==============================
    # where the data is taken to add in list
    lbl_title = Label(FormTitle, text="Adding New Contacts", font=('arial', 16), bg="purple1",  width = 300)
    lbl_title.pack(fill=X)
...
Top.pack(side=TOP)
Mid = Frame(root, width=500,  bg="purple1")
Mid.pack(side=TOP)
MidLeft = Frame(Mid, width=100)
MidLeft.pack(side=LEFT, pady=10)
MidLeftPadding = Frame(Mid, width=370, bg="purple1")
...
#============================BUTTONS=====================================
btn_add = Button(MidLeft, text="+ ADD NEW", bg="cyan2", command=AddNewWindow)
btn_add.pack()
btn_delete = Button(MidRight, text="DELETE", bg="cyan2", command=DeleteData)
btn_delete.pack(side=RIGHT)

#============================TABLES======================================
#here the data is ton be showed
